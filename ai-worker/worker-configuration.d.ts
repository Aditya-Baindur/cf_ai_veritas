/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cf7404ad23138a40450e947efd591df5)
// Runtime types generated with workerd@1.20260116.0 2026-01-03
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
	}
	interface Env {
		GOOGLE_API_KEY: '[your_api_key] https://developers.google.com/custom-search/v1/introduction]';
		GOOGLE_CX: '[your_api_key] https://developers.google.com/custom-search/v1/introduction]';
		BRAVE_API_KEY: '[brave_api_key] : https://brave.com/search/api/]';
		db: D1Database;
		AI: Ai;
		search_workflow: Workflow /* SearchWorkflow */;
		normal_workflow: Workflow /* NormalWorkflow */;
		reasoning_workflow: Workflow /* ReasoningWorkflow */;
		dev_workflow: Workflow /* DevWorkflow */;
	}
}
